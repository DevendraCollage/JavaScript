...
// They are directly not related to the document, but represents pure browser methods of communicating with the user.
...
//? history Object:
// Represents the session history, allowing through the browser history.
// Example: window.history.back(), window.history.forward().

//? screen Object:
// Represents information about the user's screen.
// Example: widow.screen.width, window.screen.height.

//? window.localStorage, window.sessionStorage
// Objects for storing data persistently of for the duration of a page session.
...
// The javascript history object provided an array of URLs visited by the user. By using this object, you can load previous, forward or any particular page.
...
// Example: console.log(window.location.assign("https://www.google.com"));
...
// Returns the number of bits used to represents each pixel.
